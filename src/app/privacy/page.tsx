...
export const metadata: Metadata = { title: 'Privacy', description: 'Privacy policy for Foveo and the Foveo Chrome extension.' }

export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-16">
      <h1 className="text-3xl font-extrabold">Privacy Policy</h1>
      <p className="mt-1 text-sm text-muted">Foveo · aggiornata 2026-08-26</p>

      <p className="mt-6">Foveo cattura uno screenshot di una pagina che <b>scegli esplicitamente di analizzare</b> e lo usa per generare una heatmap di attenzione e un’analisi orientata alla conversione.</p>
